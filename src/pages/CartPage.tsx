  ...
  if (cart.length === 0) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center space-y-6 px-4">
        <div className="w-24 h-24 bg-[#FDF5E6] rounded-full flex items-center justify-center text-[#D4AF37]">
          <ShoppingBag size={48} />
        </div>
        ...
        <Link
          to="/"
          className="px-10 py-4 bg-[#8B0000] text-white font-bold tracking-widest uppercase hover:bg-[#660000] transition-all"
        >
          Explore Collection
        </Link>
      </div>
