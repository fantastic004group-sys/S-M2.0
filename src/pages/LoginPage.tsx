...
export default function LoginPage() {
  ...
  return (
    <ZoomPage>
      <ZoomSection className="bg-[#FDF5E6]">
        <motion.div
          initial={{ opacity: 0, scale: 0.95 }}
          animate={{ opacity: 1, scale: 1 }}
          className="max-w-md w-full bg-white p-12 border border-[#D4AF37]/20 shadow-xl text-center mx-auto rounded-3xl"
        >
          ...
          <button
            ...
            className="w-full py-4 border-2 border-[#2F2F2F] text-[#2F2F2F] font-bold tracking-widest uppercase hover:bg-[#2F2F2F] hover:text-white transition-all flex items-center justify-center gap-4 group rounded-full"
          >
