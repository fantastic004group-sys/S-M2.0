  ...
  if (!product) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center space-y-4">
        <h2 className="text-3xl font-display text-[#2D2D2D]">Product not found</h2>
        ...
        >
          ...
          <div className="mb-6">
            {product.stock > 5 ? (
              ...
              <span className="text-orange-600 text-sm font-semibold">Only {product.stock} left - order soon!</span>
            ) : (
            ...
            <div className="flex items-center gap-4 mb-8">
              <div className="flex items-center border border-warm-border rounded-full overflow-hidden">
                <button
                  ...
                  className="p-3 hover:bg-gray-100 text-[#2D2D2D]"
                >
                  <Minus size={16} />
                </button>
